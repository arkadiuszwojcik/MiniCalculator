...
{
    [TestFixture]
    class TestCombinedProbabilityCalculator
    {
        [TestCase(1.1f)]
        [TestCase(-0.1f)]
        ...
        [TestCase(0.25f, 0.63f, 0.1575f)]
        public void Is_evaluating_combined_probability(float probabilityA, float probabilityB, float result)
        {
        ...
        public void Setup()
        {
            this.calculator = new CombinedProbabilityCalculator();
        }

        private const float Epsilon = 0.0000001f;
        private ICombinedProbabilityCalculator calculator;
    }
}
